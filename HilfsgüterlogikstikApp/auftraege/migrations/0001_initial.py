...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ItemBestand',
            fields=[
                ('bestand_id', models.AutoField(primary_key=True, serialize=False)),
                ('item_name', models.CharField(max_length=255)),
                ('gesamtmenge', models.IntegerField(default=0)),
                ('beschreibung', models.TextField(blank=True, null=True)),
                ('auftrag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='item_bestand', to='auftraege.auftrag')),
            ],
            options={
